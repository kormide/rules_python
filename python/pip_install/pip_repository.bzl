...
def _internal_deps_aliases():
    build_content = ""

    # Also add alias for dependencies required by rules_python itself
    # Keep in sync with internal_deps.bzl
...
def _pip_repository_impl(rctx):
    ...
    build_contents += _internal_deps_aliases()
...
pip_repository_attrs = {
    ...
    "bzlmod": attr.bool(
        default = False,
        doc = """Indicated whether this repository rule is invoked under bzlmod, in which case
